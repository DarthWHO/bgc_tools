    ...
    <Box sx={{ p: 4, maxWidth: "100%", margin: "0 auto" }}>
      <Stack spacing={2}>
        ...
        <Typography variant="body1">
          ...
          passionate board gamer with a love for creating tools that enhance
          user experiences. This project is a labor of love, and I hope it
          serves you well.
        </Typography>
        <Typography variant="body1">
          I am a software developer by hobby only. If you have any questions or
          feedback, please reach out to me on BoardGameGeek.{" "}
          <Link href="https://boardgamegeek.com/profile/darthwho">
            darthwho
          </Link>
        </Typography>
      </Stack>
